...
class MailClient
{
    ...
    public function sendByTemplate($templateId, array $users, $subject, $params = array(),$group = 'default')
    {
        return $this->adapter->sendByTemplate($templateId, $users, $subject, $params, $group);
    }
}
